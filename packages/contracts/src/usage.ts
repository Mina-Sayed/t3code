 ...
 * `~/.grok/sessions/**\/updates.jsonl`, `~/.local/share/opencode/opencode.db`)
 ...
 *
 * v6 only adds `opencode` to {@link UsageProviderKind}; v4 Claude/Codex and
 * v5 Grok buckets remain valid, so mixed-version environments keep those totals
