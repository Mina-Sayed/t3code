...
function CommandPaletteResultRow(props: {
  ...
  return (
    <CommandItem
      ...
      className={cn(
        "cursor-pointer gap-2 hover:bg-transparent hover:text-inherit data-highlighted:bg-transparent data-highlighted:text-inherit data-selected:bg-transparent data-selected:text-inherit [&[data-highlighted]]:bg-accent [&[data-highlighted]]:text-accent-foreground",
